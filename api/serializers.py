...
class PetrolPricesSerializer(serializers.HyperlinkedModelSerializer):
	...
	def to_representation(self, instance):
		...
		field['updated_on'] = instance.updated_on.strftime('%a, %d %b %Y') if instance.updated_on else None
		field['diesel_updated_on'] = instance.diesel_updated_on.strftime('%a, %d %b %Y') if instance.diesel_updated_on else None
		return field
